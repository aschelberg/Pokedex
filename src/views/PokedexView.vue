...
const { getPokemon, getAllPokemon, myPokemon } = usePokemon();
          ...
          >
            ...
            <div class="col-span-5">
              ...
              >
                ...
                <div class="flex flex-1 justify-between sm:justify-end">
                  <button
                    ...
                    class="relative inline-flex items-center rounded-md bg-blue-300 px-3 py-2 text-sm font-semibold text-gray-900 border border-blue-300 hover:bg-gray-50 focus-visible:outline-offset-0 disabled:text-gray-500 disabled:bg-gray-200 disabled:border-none transition-all"
                  >
                    Previous
                  </button>
                  <button
                    ...
                    class="relative ml-3 inline-flex items-center rounded-md bg-blue-300 px-3 py-2 text-sm font-semibold text-gray-900 border border-blue-300 hover:bg-gray-50 focus-visible:outline-offset-0 disabled:text-gray-500 disabled:bg-gray-200 disabled:border-none transition-all"
                  >
                    Next
                  </button>
                </div>
              ...
              <ul role="list" class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 md:pl-2">
                ...
                >
                  <PokemonCard :pokemon="pokemon" :savedPokemon="savedPokemon" @updated="updated"/>
                </li>
              </ul>
            </div>
          </section>
